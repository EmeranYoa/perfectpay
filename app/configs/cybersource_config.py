...
import os
from app.configs.config import settings, base_dir
...
class CyberSourceConfig:
    def __init__(self):
        ...
        self.alternative_merchantid = settings.CYBERSOURCE_MERCHANT_ID
        ...
        # HTTP PARAMETERS
        self.merchant_keyid = settings.CYBERSOURCE_MERCHANT_KEY
        self.merchant_secretkey = settings.CYBERSOURCE_MERCHANT_SECRETKEY
        self.alternative_merchant_keyid = settings.CYBERSOURCE_MERCHANT_KEY
        self.alternative_merchant_secretkey = settings.CYBERSOURCE_MERCHANT_SECRETKEY
        # META KEY PARAMETERS
